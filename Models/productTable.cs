...
namespace CloudDevelopment.Models
{
    public class productTable
    {
        ...
        public int insert_product(productTable p)
        {
            ...
            try
            {
                string sql = "INSERT INTO ProductTable (productID, productName, productPrice, productCategory, productAvailability) VALUES (@ProductID, @Name, @Price, @Category, @Availability)";
